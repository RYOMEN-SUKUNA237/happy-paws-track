...
export const mockCouriers: Courier[] = [
  {
    id: '1', courierId: 'HPT-CUR-7X92KP', name: 'Marcus Johnson', email: 'marcus@happypawstransit.com',
  ...
  {
    id: '2', courierId: 'HPT-CUR-3B81NQ', name: 'Sofia Martinez', email: 'sofia@happypawstransit.com',
  ...
  {
    id: '3', courierId: 'HPT-CUR-9D44RL', name: 'Emily Chen', email: 'emily@happypawstransit.com',
  ...
  {
    id: '4', courierId: 'HPT-CUR-5F27WT', name: 'David Okafor', email: 'david@happypawstransit.com',
  ...
  {
    id: '5', courierId: 'HPT-CUR-2H65YM', name: 'Jake Williams', email: 'jake@happypawstransit.com',
...
export const mockShipments: Shipment[] = [
  ...
  {
    id: '5', trackingId: 'HPT-1198-B7', sender: 'Book Depot', receiver: 'University Library',
    origin: 'Boston, MA', destination: 'Philadelphia, PA', status: 'delivered',
    courierId: 'HPT-CUR-9D44RL', courierName: 'Emily Chen', weight: '32.0 kg',
    type: 'Books & Documents', createdAt: '2025-01-10', estimatedDelivery: '2025-01-13',
    progress: 100, isPaused: false,
  },
  {
    id: '6', trackingId: 'HPT-6645-Z1', sender: 'Fresh Foods Co.', receiver: 'Restaurant Group',
    origin: 'San Francisco, CA', destination: 'Seattle, WA', status: 'paused',
    courierId: 'HPT-CUR-7X92KP', courierName: 'Marcus Johnson', weight: '45.0 kg',
